...
function loadBudget(): number {
  ...
  if (!savedBudget || !Number.isFinite(numericBudget) || numericBudget <= 0) {
    return 2000
  }
      ...
      <main className="dashboard-page">
        <header className="dashboard-header">
          <div>
            ...
            <p className="dashboard-subtitle">
              Here is a quick look at your financial progress this month.
            </p>
          </div>
        ...
        <section className="student-status">
          ...
          <div>
            ...
            <strong>Scholarship · September 15</strong>
          </div>
        </section>
        ...
        <section className="dashboard-summary">
          ...
          <article className="dashboard-card">
            ...
            <p>You are building your emergency fund.</p>
          </article>
        </section>
        ...
        <section className="dashboard-grid">
          ...
          <article className="dashboard-panel">
            ...
            <p className="panel-description">
              You are 65% of the way toward your emergency savings goal.
            </p>
          ...
          <article className="dashboard-panel">
            ...
            <div className="bill-list">
              <div>
                ...
                <strong>August 8 · $55</strong>
              </div>

              <div>
                <span>Rent</span>
                <strong>September 1 · $650</strong>
              </div>

              <div>
                <span>Streaming</span>
                <strong>September 3 · $12</strong>
              </div>
            </div>
          </article>
